...
const Collab = () => {
  ...
  const getRecommend = async (movie) => {
    console.log(u_id);
    const newRecommendedList1 = new Array();
    const newRecommendedList2 = new Array();
    const newRecommendedList3 = new Array();
    if (u_id) {
      var content_recommendation_url = `http://127.0.0.1:8000/predictcolab/${u_id}`;
      ...
      if (Number(result[0]) == 0) {
        alert("No movies rated!!!!!!, Recommedations based on IMDB ratings");
        ...
        for (var i = 0; i < result.length; i++) {
          ...
          if (i < 4) {
            newRecommendedList1.push(responseJson);
          } else if (i < 8) {
            newRecommendedList2.push(responseJson);
          } else {
            newRecommendedList3.push(responseJson);
          }
        }
        setMovie1(newRecommendedList1);
        setMovie2(newRecommendedList2);
        setMovie3(newRecommendedList3);
      }
    }
  };
  ...
  return (
    <div className="container-fluid movie-app">
      <div className="row d-flex align-items-center mt-4 mb-4 text-center">
